    ...
    <div className="relative w-full flex-grow flex flex-col justify-between overflow-hidden py-20 lg:py-32">
      ...
      <div className="container mx-auto px-6 relative z-10 flex flex-col items-center">
        ...
        <div className="w-full max-w-4xl mt-20 grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            { label: 'Email Me', value: 'imehjohnlamech16@gmail.com', icon: 'mail', href: 'mailto:imehjohnlamech16@gmail.com' },
            { label: 'Connect', value: 'LinkedIn / Lamech Imeh-John', icon: 'alternate_email', href: '#' },
            { label: 'Call Me', value: '+2349064942385', icon: 'call', href: 'tel:+2349064942385' }
          ].map(contact => (
            <a 
              key={contact.label}
              href={contact.href}
