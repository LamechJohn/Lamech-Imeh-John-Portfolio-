          ...
          >
            ...
            <div className="flex flex-col gap-4 px-4 pb-6">
              <div className="flex items-start justify-between gap-4">
                ...
                <button className="hidden md:flex size-10 items-center justify-center rounded-full bg-primary/10 text-primary transition-all group-hover:bg-primary group-hover:text-white">
